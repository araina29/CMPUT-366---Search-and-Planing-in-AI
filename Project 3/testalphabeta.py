...
#ALPHA-BETA is a method for reducing the number of nodes explored in the Minimax strategy.
...
def alpha_beta(board, player, alpha, beta, ply):
	return main(board,player,alpha,beta,ply,1)

#Initialising a minmax function with 6th argument as The total number of expanded nodes there are 
def main(board, x_player, alpha, beta, ply,total_nodes):
	"""
	...
	if x_player == "X":
		...
		for move in board.available_moves():
			...
			total_nodes += 1
			#At every iteration we recall the alpha_beta function to get a new score everytime.
			n_score ,a , total_nodes = main(board, o_player, alpha, beta, ply - 1, total_nodes)
